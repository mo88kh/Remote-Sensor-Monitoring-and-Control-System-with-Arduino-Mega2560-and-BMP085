...
<html>
  ...
  <body>
    ...
    <h3 style="color: #0c6980;">MEGA_01 RECORD DATA TABLE</h3>
    ...
    <table class="styled-table" id= "table_id">
      ...
      <tbody id="tbody_table_record">
        <?php
          ...
          $sql = 'SELECT * FROM mega2560_table_bmp085_leds_record ORDER BY date, time';
          foreach ($pdo->query($sql) as $row) {
            ...
            echo '<td class="bdr">'. $row['pressure'] . '</td>';
            echo '<td class="bdr">'. $row['altitude'] . '</td>';
